...
function make_init(method_, token, data) {
  ...
  var default_init = function (param, param$1, param$2) {
    return Curry._6(func, /* Some */[method_], /* Some */[make_headers(token)], param, param$1, param$2, /* Some */[/* NoCORS */2]);
  };
  if (data) {
...
function loginUser(credentials) {
  var data = user(credentials);
  console.log(user(credentials));
  var request = make_init(/* Post */2, /* None */0, /* Some */[data]);
  console.log(request);
  fetch("http://127.0.0.1:7782/users", request).then((function (prim) {
            return prim.text();
          })).then((function (text) {
