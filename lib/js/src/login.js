...
function loginUser(_, param, $$event) {
  ...
  JsonRequests.authenticateUser((function (_, jsonPayload) {
          return jsonPayload.then((function (json) {
                        JsonRequests.parseCurrentUser(json);
                        var updatedState_000 = /* email */state[/* email */0];
                        var updatedState_001 = /* password */state[/* password */1];
                        var updatedState_003 = /* errorList */state[/* errorList */3];
