...
var loginErrorResponse = "{\"errors\":{\"email or password\":[\"is invalid\"]}}";
...
describe("New user request", (function () {
        ...
        Jest.test("should have the correct username", (function () {
                return Jest.ExpectJs[/* toBe */1]("bryant")(Jest.ExpectJs[/* expect */0](JsonRequests.parseNewUser(succesWithJson)[/* user */1][/* username */4]));
              }));
        Jest.test("should parse user", (function () {
                var result = JsonRequests.parseCurrentUser(loginErrorResponse);
                return Jest.ExpectJs[/* toBeGreaterThan */4](0)(Jest.ExpectJs[/* expect */0](List.length(result)));
              }));
        return Jest.test("should return error with wrong username password", (function () {
                      JsonRequests.parseCurrentUser(loginErrorResponse);
                      return Jest.ExpectJs[/* toBe */1](/* true */1)(Jest.ExpectJs[/* expect */0](/* true */1));
                    }));
      }));
