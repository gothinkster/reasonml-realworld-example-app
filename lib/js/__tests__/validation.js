...
describe("New user request", (function () {
        ...
        return Jest.test("should return error with wrong username password", (function () {
                      ...
                      var convertToDict = function (json) {
                        var errorJson = Js_json.decodeObject(json);
                        if (errorJson) {
                          var errorList = errorJson[0];
                          var errorKeys = Object.keys(errorList);
                          var errorValues = Js_dict.values(errorList);
                          var errorArray = $$Array.mapi((function (acc, errorField) {
                      ...
                      if (result.tag) {
                        ...
                        var errorList = result[0];
                        convertToDict(errorList);
