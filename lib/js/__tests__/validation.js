...
describe("New user request", (function () {
        ...
        return Jest.test("should return an error graph", (function () {
                      var result = JsonRequests.checkForErrors(loginErrorResponse);
                      if (result) {
                        return Jest.ExpectJs[/* toBe */1](/* true */1)(Jest.ExpectJs[/* expect */0](/* true */1));
                      } else {
                        return Jest.ExpectJs[/* toBe */1](/* true */1)(Jest.ExpectJs[/* expect */0](/* false */0));
                      }
                    }));
      }));
