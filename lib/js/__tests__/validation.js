...
describe("New user request", (function () {
        ...
        return Jest.test("should properly parse a successful registration", (function () {
                      var newUser = JsonRequests.parseNewUser(successJson);
                      console.log(newUser);
                      if (newUser.tag) {
                        return Jest.ExpectJs[/* toEqual */11](1)(Jest.ExpectJs[/* expect */0](0));
                      } else {
                        return Jest.ExpectJs[/* toBe */1](12123)(Jest.ExpectJs[/* expect */0](newUser[0][/* id */0]));
                      }
                    }));
      }));
