        ...
        <div className="container">
          ...
          <div className="article-meta">
            ...
            <button className="btn btn-sm btn-outline-secondary">
              ...
              (show "&nbsp;")
              (show "Follow Eric Simons") <span className="counter">(show "(10)")</span>
            </button>
            (show "&nbsp;&nbsp;")
            <button className="btn btn-sm btn-outline-primary">
              <i className="ion-heart"/>
              (show "&nbsp;")
              (show "Favorite Post") <span className="counter">(show "(29)")</span>
            </button>
          </div>
      ...
      <div className="container page">
        ...
        <div className="row article-content">
          <div className="col-md-12">
            <p>
            (show "Web development technologies have evolved at an incredible clip over the past few years.")
            </p>
        ...
        <div className="row">    
          <div className="col-xs-12 col-md-8 offset-md-2">    
            ...
            <div className="card">
              <div className="card-block">
                <p className="card-text">(show "With supporting text below as a natural lead-in to additional content.")</p>
              </div>
              <div className="card-footer">
